...
left alone in the box for 15 minutes. BpodEual pokes will 
...
"""
    ...
    def create_trial(self):
        ...
        self.bpod.add_state(
            ...
            state_timer= 0,
            state_change_conditions={BpodEvent.Port1In: 'left_poke',
                                     BpodEvent.Port2In: 'center_poke',
                                     BpodEvent.Port3In: 'right_poke'},
            output_actions=[],
        )
        ...
        self.bpod.add_state(
            ...
            output_actions=[(BpodOutput.Valve1, 1)],
        )
        ...
        self.bpod.add_state(
            ...
            output_actions=[(BpodOutput.Valve2, 1)],
        )
        ...
        self.bpod.add_state(
            ...
            output_actions=[(BpodOutput.Valve3, 1)],
        )
